...
impl DoorcamConfig {
    ...
    pub fn load_from_file<P: AsRef<Path>>(path: P) -> Result<Self, ConfigError> {
        ...
        let settings = Config::builder()
            ...
            .set_default("system.event_bus_capacity", default_event_bus_capacity() as i64)?
    ...
    pub fn validate(&self) -> Result<(), ConfigError> {
        ...
        if self.system.ring_buffer_capacity == 0 {
            return Err(ConfigError::Message("Ring buffer capacity must be greater than 0".to_string()));
        }

        if self.system.event_bus_capacity == 0 {
            return Err(ConfigError::Message("Event bus capacity must be greater than 0".to_string()));
        }
...
fn default_camera_format() -> String { "MJPG".to_string() }
...
fn default_framebuffer_device() -> String { "/dev/fb0".to_string() }
...
fn default_ring_buffer_capacity() -> usize { 150 }
fn default_event_bus_capacity() -> usize { 100 }
